        ...
        with codecs.open(annotation_filepath, "r", "UTF-8") as f:
            for line in f.read().splitlines():
                ...
                if id_anno[0] == "T":
                    ...
                    if replace_unicode_whitespaces_with_ascii_whitespace(
                        text2[entity["start"] : entity["end"]]
                    ) != replace_unicode_whitespaces_with_ascii_whitespace(
                        entity["text"]
                    ):
                        print("Warning: brat text and annotation do not match.")
                        print(
                            "\ttext: {0}".format(text2[entity["start"] : entity["end"]])
                        )
...
def check_brat_annotation_and_text_compatibility(brat_folder):
    ...
    for text_filepath in text_filepaths:
        ...
        _, _ = get_entities_from_brat(text_filepath, annotation_filepath)
    print("Done.")
...
def brat_to_conll(input_folder, output_filepath, language):
    ...
    print("{} files to process ...".format(len(text_filepaths)))
